...
<body class="min-h-screen">
    ...
    <section class="container mx-auto py-16 px-4">
        <h2 class="text-4xl md:text-5xl font-bold text-[#092468] text-center animate-section-title">Current Job Openings</h2>
        <p class="text-gray-600 text-lg text-center mt-4 mb-12 max-w-3xl mx-auto animate-card">
            Explore exciting career opportunities at <strong>PishonServ</strong>. We are looking for passionate individuals to join our mission of revolutionizing real estate.
        </p>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 px-6 md:px-10">
            <div class="job-card bg-white p-6 rounded-lg shadow-md animate-card" style="animation-delay: 0.2s;">
                ...
                <p class="text-gray-600 mb-4">
                    ...
                    <strong>Description:</strong> We are seeking a dynamic Real Estate Sales Agent to join our team. You will work closely with clients to help them buy, sell, or rent properties, providing expert guidance and exceptional service.
                </p>
                <a href="mailto:careers@pishonserv.com?subject=Application%20for%20Real%20Estate%20Sales%20Agent" class="btn-primary text-white px-4 py-2 rounded-lg font-semibold">Apply Now</a>
            </div>
            <div class="job-card bg-white p-6 rounded-lg shadow-md animate-card" style="animation-delay: 0.4s;">
                ...
                <p class="text-gray-600 mb-4">
                    <strong>Location:</strong> Lagos, Nigeria<br>
                    <strong>Type:</strong> Full-Time<br>
                    <strong>Description:</strong> Join our marketing team to create and execute campaigns that promote our properties and brand. Ideal candidates are creative, organized, and experienced in digital marketing.
                </p>
                <a href="mailto:careers@pishonserv.com?subject=Application%20for%20Marketing%20Coordinator" class="btn-primary text-white px-4 py-2 rounded-lg font-semibold">Apply Now</a>
            </div>
             <div class="job-card bg-white p-6 rounded-lg shadow-md animate-card" style="animation-delay: 0.4s;">
                <h3 class="text-xl font-semibold text-[#092468] mb-2">Marketing Coordinator</h3>
                <p class="text-gray-600 mb-4">
    ...
    <section class="container mx-auto py-16 px-4 bg-gray-100">
        <h2 class="text-4xl md:text-5xl font-bold text-[#092468] text-center animate-section-title">Why Work With Us</h2>
        <p class="text-gray-600 text-lg text-center mt-4 mb-12 max-w-3xl mx-auto animate-card">
            At <strong>PishonServ</strong>, we foster a culture of growth, collaboration, and innovation. Join us to make a meaningful impact in the real estate industry.
        </p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 px-6 md:px-10">
            <div class="job-card bg-white p-6 rounded-lg shadow-md animate-card" style="animation-delay: 0.2s;">
                ...
                <p class="text-gray-600">
                    We invest in your professional development with training programs and career advancement opportunities to help you reach your full potential.
                </p>
            </div>
            <div class="job-card bg-white p-6 rounded-lg shadow-md animate-card" style="animation-delay: 0.4s;">
                <h3 class="text-xl font-semibold text-[#092468] mb-2">Collaborative Environment</h3>
                <p class="text-gray-600">
                    Work alongside a passionate team in a supportive and inclusive workplace where your ideas are valued and collaboration drives success.
                </p>
            </div>
            <div class="job-card bg-white p-6 rounded-lg shadow-md animate-card" style="animation-delay: 0.6s;">
                ...
                <p class="text-gray-600">
                    Be part of a mission to transform real estate, helping clients find their dream properties and making a lasting difference in communities.
                </p>
            </div>
        </div>
    </section>
