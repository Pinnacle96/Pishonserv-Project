...
<ul>
    ...
    <?php } elseif (in_array($user_role, ['agent', 'owner', 'hotel_owner', 'developer'])) { ?>
    ...
    <li><a href="admin_products.php" class="sidebar-link"><i class="fas fa-money-bill"></i> Manage Products</a>
    </li>
