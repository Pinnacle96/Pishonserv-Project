...
$category_slug = 'furniture'; // or 'furniture' for other page
...
<body class="min-h-screen">
    ...
    <section class="container mx-auto py-16 px-4">
        <h2 class="text-4xl md:text-5xl font-bold text-[#092468] text-center animate-section-title">Our Furniture
            Collection</h2>
        <p class="text-gray-600 text-lg text-center mt-4 mb-12 max-w-3xl mx-auto animate-card">
            Browse our selection of stylish and durable furniture pieces, perfect for any home or office space. View
            details or add to your cart to start shopping.
        </p>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-6 md:px-10">
            ...
            <div class="product-card bg-white p-6 rounded-lg shadow-md animate-card">
                ...
                <div class="flex space-x-4">
                    <a href="product_detail.php?id=<?php echo $product['id']; ?>&category=furniture"
