            ...
            <ul class="hidden md:flex space-x-8 text-lg text-[#092468] font-medium">
                ...
                <li class="relative group">
                    ...
                    <div class="absolute left-0 hidden group-hover:block bg-white shadow-md rounded mt-1 w-40 z-10">
                        <a href="<?php echo $base_path; ?>interior_deco.php"
                            class="block px-4 py-2 text-[#092468] hover:bg-gray-100">Interior Deco</a>
                        <a href="<?php echo $base_path; ?>furniture.php"
                            class="block px-4 py-2 text-[#092468] hover:bg-gray-100">Furniture</a>
                    </div>
                </li>
            ...
            <ul class="text-center text-[#092468] text-lg">
                ...
                <li class="py-3 border-b relative group">
                    ...
                    <ul class="bg-white text-[#092468] text-sm hidden group-hover:block">
                        <li><a href="<?php echo $base_path; ?>interior_deco.php"
                                class="block px-4 py-2 hover:bg-gray-100">Interior Deco</a></li>
                        <li><a href="<?php echo $base_path; ?>furniture.php"
                                class="block px-4 py-2 hover:bg-gray-100">Furniture</a></li>
                    </ul>
                </li>
